...
public class Vision {
  ...
  public static String query(String index_filename, Mat image) {
    return VisionProxyJNI.Vision_query(index_filename, Mat.getCPtr(image), image);
  }
  ...
  public static FindResults findBlobs(Mat image, boolean textOnly) {
    return new FindResults(VisionProxyJNI.Vision_findBlobs__SWIG_0(Mat.getCPtr(image), image, textOnly), true);
  }

  public static FindResults findBlobs(Mat image) {
    return new FindResults(VisionProxyJNI.Vision_findBlobs__SWIG_1(Mat.getCPtr(image), image), true);
  }

  public static FindResults findTextBlobs(Mat image) {
    return new FindResults(VisionProxyJNI.Vision_findTextBlobs(Mat.getCPtr(image), image), true);
  }
